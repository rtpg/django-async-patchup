...
class ModelOverrides:
    ...
    @from_codegen(original=Model.save)
    def save(
        self,
        *,
        force_insert=False,
    ...
    @from_codegen(original=Model.save_base)
    def save_base(
        self,
        raw=False,
        force_insert=False,
    ...
    @generate_unasynced(sync_variant=Model.save_base)
    ...
    @from_codegen(original=Model._save_parents)
    def _save_parents(
    ...
    @generate_unasynced(sync_variant=Model._save_parents)
    ...
    @from_codegen(original=Model._save_table)
    def _save_table(
        self,
        raw=False,
        cls=None,
    ...
    @generate_unasynced(sync_variant=Model._save_table)
    ...
    @from_codegen(original=Model._do_update)
    ...
    @generate_unasynced(sync_variant=Model._do_update)
    ...
    @from_codegen(original=Model._do_insert)
    ...
    @generate_unasynced(sync_variant=Model._do_insert)
