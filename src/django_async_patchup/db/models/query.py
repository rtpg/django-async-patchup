...
class QuerySetOverrides:
    ...
    @from_codegen(original=QuerySet._fetch_all)
    def _fetch_all(self):
...
class ModelIterableOverrides:
    ...
    @from_codegen(original=QuerySet.count)
    def count(self):
        """
    ...
    @from_codegen(original=QuerySet.get)
    ...
    @from_codegen(original=QuerySet.create)
    ...
    @from_codegen(original=QuerySet.bulk_create)
    def bulk_create(
        self,
        objs,
        batch_size=None,
    ...
    @from_codegen(original=QuerySet.bulk_update)
    ...
    @from_codegen(original=QuerySet.get_or_create)
    ...
    @from_codegen(original=QuerySet.update_or_create)
    ...
    @from_codegen(original=QuerySet._earliest)
    ...
    @from_codegen(original=QuerySet.earliest)
    ...
    @from_codegen(original=QuerySet.latest)
    ...
    @from_codegen(original=QuerySet.first)
    def first(self):
    ...
    @from_codegen(original=QuerySet.last)
    def last(self):
    ...
    @from_codegen(original=QuerySet.in_bulk)
    ...
    @from_codegen(original=QuerySet.delete)
    def delete(self):
    ...
    @from_codegen(original=QuerySet._raw_delete)
    ...
    @from_codegen(original=QuerySet.update)
    ...
    @from_codegen(original=QuerySet._update)
    ...
    @from_codegen(original=QuerySet.exists)
    def exists(self):
        """
    ...
    @from_codegen(original=QuerySet.contains)
    ...
    @from_codegen(original=QuerySet._prefetch_related_objects)
    ...
    @from_codegen(original=QuerySet._insert)
    def _insert(
        self,
        objs,
        fields,
    ...
    @from_codegen(original=QuerySet._batched_insert)
    def _batched_insert(
        self,
        objs,
        fields,
...
class RawQuerySetOverrides:
    ...
    @from_codegen(original=RawQuerySet._prefetch_related_objects)
    def _prefetch_related_objects(self):
        prefetch_related_objects(self._result_cache, *self._prefetch_related_lookups)
        self._prefetch_done = True
